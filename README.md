...
> Local: `http://localhost:4173` via `.\scripts\dev-windows.ps1` (port 5173 is OSP World Track).
> Weather roadmap: [engineering review and live imagery plan](docs/LIVE-WEATHER-IMAGERY-PLAN.md).
